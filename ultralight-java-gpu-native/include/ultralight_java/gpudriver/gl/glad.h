...
/*
    ...
    Commandline:
        --profile="compatibility" --api="gl=3.2" --generator="c" --spec="gl" --no-loader
   --extensions="GL_ARB_multisample,GL_ARB_robustness,GL_KHR_debug" Online:
...
typedef void *(
    APIENTRYP PFNGLMAPBUFFERRANGEPROC) (GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
...
typedef void(APIENTRYP PFNGLGETNTEXIMAGEARBPROC)(
    GLenum target, GLint level, GLenum format, GLenum type, GLsizei bufSize, void *img);
...
typedef void(APIENTRYP PFNGLGETNCOLORTABLEARBPROC)(
...
typedef void(APIENTRYP PFNGLGETNHISTOGRAMARBPROC)(
...
typedef void(APIENTRYP PFNGLGETNMINMAXARBPROC)(
    GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, void *values);
